...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_de_spot.csv', ...
    param_out_de_spot);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/forecast_de_spot.csv', ...
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_de_intraday.csv', ...
    param_out_de_intraday);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/forecast_de_intraday.csv', ...
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_fr_spot.csv', ...
    param_out_fr_spot);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/forecast_fr_spot.csv', ...
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_fr_intraday.csv', ...
    param_out_fr_intraday);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/forecast_fr_intraday.csv', ...
