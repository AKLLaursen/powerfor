...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/param_de_spot.csv', ...
    param_out_de_spot);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/forecast_de_spot.csv', ...
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/param_de_intraday.csv', ...
    param_out_de_intraday);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/forecast_de_intraday.csv', ...
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/param_fr_spot.csv', ...
    param_out_fr_spot);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/forecast_fr_spot.csv', ...
...
for ii = 720:725
    ...
    data_tmp = csvread(sprintf('C:/git/r/powerfor/inst/csv/hour_10/forecast_data_fr_intraday/data_%i.csv', ii));
    [n, ~] = size(data_tmp);    
%     input_param = csvread('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output hour 10/param_fr_intraday.csv');
%     input_param = input_param(ii, :)';
%     
%     theta = ones(23, 1) * 0.2;
%     theta(1:7) = input_param(8:14);
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/param_fr_intraday.csv', ...
    param_out_fr_intraday);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_2/forecast output hour 4/forecast_fr_intraday.csv', ...
