...
for ii = 1:730
    ...
    input_param = csvread('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_de_spot.csv');
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/param_de_spot.csv', ...
    param_out_de_spot);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/forecast_de_spot.csv', ...
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/param_de_intraday.csv', ...
    param_out_de_intraday);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/forecast_de_intraday.csv', ...
...
for ii = 1:730
    ...
    data_tmp = data_tmp(2:end, :);
    input_param = csvread('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_fr_spot.csv');
    input_param = input_param(ii, :)';
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/param_fr_spot.csv', ...
    param_out_fr_spot);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/forecast_fr_spot.csv', ...
...
for ii = 1:730
    ...
    input_param = csvread('C:/git/r/powerfor/inst/matlab/log_lik_model_1/forecast output/param_fr_intraday.csv');
    input_param = input_param(ii, :)';
...
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/param_fr_intraday.csv', ...
    param_out_fr_intraday);
csvwrite('C:/git/r/powerfor/inst/matlab/log_lik_model_3/forecast output/forecast_fr_intraday.csv', ...
